...
test("the current OpenCode catalogs remain fully fetchable without preselecting Zen", () => {
  ...
  const goLive = [
    ...
    "gpt-5.6-luna", "gpt-6-luna", "grok-4.5", "grok-4.6", "hy3", "hy3-preview", "kimi-k2.5", "kimi-k2.6",
    ...
    "qwen3.7-max", "qwen3.7-plus", "qwen3.8-flash", "qwen3.8-max", "space-bunny-free",
  ];
  assert.deepEqual(
...
test("the checked-in OpenCode Go set matches the official current-model table", () => {
  const documented = [
    ...
    "gpt-5.6-luna", "gpt-6-luna", "grok-4.5", "grok-4.6", "hy3", "hy4-preview", "kimi-k2.5", "kimi-k2.6", "kimi-k2.7-code", "kimi-k3", "longcat-2.0",
    ...
    "qwen3.7-plus", "qwen3.8-flash", "qwen3.8-max", "space-bunny-free",
  ].sort();
